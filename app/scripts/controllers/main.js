...
/**
 * @ngdoc function
 * @name passionDrivenPortfolio.controller:MainCtrl
 * @description
 * # MainCtrl
 * Controller of the passionDrivenPortfolio
 */
angular.module('app.controllers', []).controller('MainCtrl', ['$scope',
//     function($scope) {}
...
}).controller('ScrollController', ['anchorSmoothScroll', '$location', '$scope',
